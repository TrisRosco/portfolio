    ...
    <div className="interface">
      ...
      <div className="interface-container">
        <Card color="#4a4a4a">
          <Card color="#3a3a3a">
            ...
            <p>
              ...
              <br />
              It doesn't matter who you are, you can't resist flicking one of
              those things! I wanted to replicate the feeling of that satisfying
              click
            </p>
          </Card>
          <ClickySwitch2 />
          <Card color="#3a3a3a">
            <p>
              ...
              <br />
              The handle is a circle with a series of box-shadows stacked on top
              of each other, each one slightly offset and darker than the last.
              This gives the illusion of depth and makes it look like a 3D
              object.
              <br />
              <br />
              ...
              subtle elastic animation, the underlying logic is my own, and
              still would be possible without it.
              <br />
              When the user starts dragging the handle, the switch checks the x
              offset of the handle. If it's greater than 0, the switch is turned
              on, and vice versa.
              <br />
              A useState hook is used to keep track of the switch's state, and
              when the state changes, the switch plays a sound and vibrates the
              device.
              <br />
              At the same time, the useState is handed to the CSS as a data
              attribute, which is used to switch the direction of the
              box-shadows, and sets the flex direction of the handle to the
              opposite direction.
            </p>
          </Card>
        </Card>
        ...
        <p>
          ...
          <br />
          <br />
          This one is a little more complicated, but it's fairly intuitive once
          you get the hang of it.
          <br />
          The idea is that it's not as easy to accidentally as the flick switch,
        ...
        <p>
          ...
          inner, and handle.
          <br />
          The functionality is very similar to the flick switch, but instead of
          checking the x offset against 0, it checks it against a pre-defined
          threshold.
          <br />
          If the offset is greater than the threshold, the switch is turned on,
          and vice versa.
          <br />
        ...
        <p>Tap to toggle</p>
        <p>
          This is the simplest switch, it's essentially a rocker switch like
          you'd use to turn on a light.
          <br />
